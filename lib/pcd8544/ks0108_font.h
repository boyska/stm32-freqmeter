...
// original was "1025":[20,30,2,2,30,2,62,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1025={6, {0x00,0x7e,0x53,0x52,0x53,0x40}}; // Ё

// original was "1040":[0,24,36,34,34,62,34,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1040={6, {0x00,0x78,0x24,0x22,0x22,0x7c}}; // А

// original was "1041":[0,30,2,30,34,34,62,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1041={6, {0x00,0x7e,0x4a,0x4a,0x4a,0x70}}; // Б

// original was "1042":[0,30,34,30,34,34,62,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1042={6, {0x00,0x7e,0x4a,0x4a,0x4a,0x74}}; // В

// original was "1043":[0,30,2,2,2,2,2,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1043={5, {0x00,0x7e,0x02,0x02,0x02}}; // Г
...
// original was "1045":[0,30,2,2,30,2,62,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1045={6, {0x00,0x7e,0x52,0x52,0x52,0x40}}; // Е

// original was "1046":[0,146,146,146,124,146,146,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1046={8, {0x00,0x6e,0x10,0x10,0x7e,0x10,0x10,0x6e}}; // Ж

// original was "1047":[0,30,32,28,32,32,62,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1047={6, {0x00,0x42,0x4a,0x4a,0x4a,0x74}}; // З

// original was "1048":[0,34,34,50,42,38,34,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1048={6, {0x00,0x7e,0x20,0x10,0x08,0x7e}}; // И

// original was "1049":[8,42,34,50,42,38,34,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1049={6, {0x00,0x7e,0x20,0x13,0x08,0x7e}}; // Й

// original was "1050":[0,50,10,6,10,18,34,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1050={6, {0x00,0x7e,0x08,0x14,0x22,0x42}}; // К

// original was "1051":[0,56,36,36,36,36,38,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1051={6, {0x00,0x40,0x7c,0x02,0x02,0x7e}}; // Л

// original was "1052":[0,130,130,198,238,146,146,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1052={8, {0x00,0x7e,0x18,0x10,0x60,0x10,0x18,0x7e}}; // М

// original was "1053":[0,34,34,34,62,34,34,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1053={6, {0x00,0x7e,0x10,0x10,0x10,0x7e}}; // Н

// original was "1054":[0,28,34,34,34,34,28,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1054={6, {0x00,0x3c,0x42,0x42,0x42,0x3c}}; // О

// original was "1055":[0,62,34,34,34,34,34,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1055={6, {0x00,0x7e,0x02,0x02,0x02,0x7e}}; // П

// original was "1056":[0,30,34,34,34,30,2,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1056={6, {0x00,0x7e,0x22,0x22,0x22,0x1c}}; // Р

// original was "1057":[0,60,2,2,2,2,60,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1057={6, {0x00,0x3c,0x42,0x42,0x42,0x42}}; // С

// original was "1058":[0,62,8,8,8,8,8,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1058={6, {0x00,0x02,0x02,0x7e,0x02,0x02}}; // Т

// original was "1059":[0,34,34,34,20,8,6,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1059={6, {0x00,0x4e,0x50,0x20,0x10,0x0e}}; // У
...
// original was "1061":[0,34,20,8,8,20,34,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1061={6, {0x00,0x42,0x24,0x18,0x24,0x42}}; // Х
...
// original was "1063":[0,34,34,34,60,32,32,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1063={6, {0x00,0x0e,0x10,0x10,0x10,0x7e}}; // Ч

// original was "1064":[0,146,146,146,146,146,254,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1064={8, {0x00,0x7e,0x40,0x40,0x7e,0x40,0x40,0x7e}}; // Ш

// original was "1065":[0,146,146,146,146,146,510,256,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1065={9, {0x00,0x7e,0x40,0x40,0x7e,0x40,0x40,0x7e,0xc0}}; // Щ

// original was "1066":[0,6,60,68,68,68,60,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1066={7, {0x00,0x02,0x7e,0x44,0x44,0x44,0x38}}; // Ъ

// original was "1067":[0,130,158,162,162,162,158,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1067={8, {0x00,0x7e,0x44,0x44,0x44,0x38,0x00,0x7e}}; // Ы

// original was "1068":[0,2,30,34,34,34,30,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1068={6, {0x00,0x7e,0x44,0x44,0x44,0x38}}; // Ь

// original was "1069":[0,30,32,60,32,32,30,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1069={6, {0x00,0x42,0x4a,0x4a,0x4a,0x3c}}; // Э

// original was "1070":[0,114,138,138,142,138,114,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1070={8, {0x00,0x7e,0x10,0x3c,0x42,0x42,0x42,0x3c}}; // Ю

// original was "1071":[0,60,34,34,60,36,34,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1071={6, {0x00,0x4c,0x32,0x12,0x12,0x7e}}; // Я

// original was "1072":[0,0,12,16,28,18,44,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1072={6, {0x00,0x20,0x54,0x54,0x38,0x40}}; // а

// original was "1073":[0,0,14,2,6,10,6,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1073={4, {0x00,0x7c,0x54,0x24}}; // б

// original was "1074":[0,0,6,10,14,18,14,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1074={5, {0x00,0x7c,0x54,0x58,0x20}}; // в

// original was "1075":[0,0,14,2,2,2,2,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1075={4, {0x00,0x7c,0x04,0x04}}; // г

// original was "1076":[0,0,24,20,20,20,30,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1076={5, {0x00,0x40,0x78,0x44,0x7c}}; // д

// original was "1077":[0,0,12,18,14,2,12,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1077={5, {0x00,0x38,0x54,0x54,0x08}}; // е

// original was "1078":[0,0,42,42,42,28,42,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1078={6, {0x00,0x5c,0x20,0x7c,0x20,0x5c}}; // ж

// original was "1079":[0,6,8,4,8,10,6,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1079={4, {0x00,0x62,0x4a,0x34}}; // з

// original was "1080":[0,0,18,18,26,22,18,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1080={5, {0x00,0x7c,0x20,0x10,0x7c}}; // и

// original was "1081":[8,8,18,18,26,22,18,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1081={5, {0x00,0x7c,0x20,0x13,0x7c}}; // й

// original was "1082":[0,0,18,10,6,10,18,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1082={5, {0x00,0x7c,0x10,0x28,0x44}}; // к

// original was "1083":[0,0,28,20,20,20,18,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1083={5, {0x00,0x40,0x3c,0x04,0x7c}}; // л

// original was "1084":[0,0,34,34,54,42,42,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1084={6, {0x00,0x7c,0x10,0x60,0x10,0x7c}}; // м

// original was "1085":[0,0,10,10,14,10,10,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1085={4, {0x00,0x7c,0x10,0x7c}}; // н

// original was "1086":[0,0,4,10,10,10,4,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1086={4, {0x00,0x38,0x44,0x38}}; // о

// original was "1087":[0,0,14,10,10,10,10,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1087={4, {0x00,0x7c,0x04,0x7c}}; // п

// original was "1088":[0,0,6,10,10,10,6,2,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1088={4, {0x00,0xfc,0x44,0x38}}; // р

// original was "1089":[0,0,12,2,2,2,12,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1089={4, {0x00,0x38,0x44,0x44}}; // с

// original was "1090":[0,0,14,4,4,4,4,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1090={4, {0x00,0x04,0x7c,0x04}}; // т

// original was "1091":[0,0,10,10,10,4,2,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1091={4, {0x00,0x5c,0x20,0x1c}}; // у

// original was "1092":[0,8,28,42,42,28,8,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1092={6, {0x00,0x18,0x24,0x7e,0x24,0x18}}; // ф

// original was "1093":[0,0,10,10,4,10,10,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1093={4, {0x00,0x6c,0x10,0x6c}}; // х

// original was "1094":[0,0,10,10,10,10,30,16,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1094={5, {0x00,0x7c,0x40,0x7c,0xc0}}; // ц

// original was "1095":[0,0,10,10,10,12,8,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1095={4, {0x00,0x1c,0x20,0x7c}}; // ч

// original was "1096":[0,0,34,34,42,42,62,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1096={6, {0x00,0x7c,0x40,0x70,0x40,0x7c}}; // ш

// original was "1097":[0,0,34,34,42,42,126,64,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1097={7, {0x00,0x7c,0x40,0x70,0x40,0x7c,0xc0}}; // щ

// original was "1098":[0,0,6,12,20,20,12,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1098={5, {0x00,0x04,0x7c,0x48,0x30}}; // ъ

// original was "1099":[0,0,34,38,42,42,38,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1099={6, {0x00,0x7c,0x48,0x30,0x00,0x7c}}; // ы

// original was "1100":[0,0,2,6,10,10,6,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1100={4, {0x00,0x7c,0x48,0x30}}; // ь

// original was "1101":[0,0,6,8,14,8,6,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1101={4, {0x00,0x54,0x54,0x38}}; // э

// original was "1102":[0,0,18,42,46,42,18,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1102={6, {0x00,0x7c,0x10,0x38,0x44,0x38}}; // ю

// original was "1103":[0,0,12,10,10,12,10,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1103={4, {0x00,0x58,0x24,0x7c}}; // я

// original was "1105":[10,0,12,18,14,2,12,0,0,0,0,0,0,0,0,0
const Ks0108Char_t char_1105={5, {0x00,0x39,0x54,0x55,0x08}}; // ё
