...
void pcd8544_clearDisplay(void);
void pcd8544_drawText(uint8_t x, uint8_t y, uint8_t color, char *text);
void pcd8544_drawTextW(uint8_t x, uint8_t y, uint8_t color, wchar_t *text);
